class DFP::LineItemService < DFP::Service
  @client = Savon::Client.new("https://sandbox.google.com/apis/ads/publisher/v201004/LineItemService?wsdl")
  ...
  soap_method(:create_line_items, :to_array => 'lineItems', :response => DFP::LineItem) { |line_items| line_items }
